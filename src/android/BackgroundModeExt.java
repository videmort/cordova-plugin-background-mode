...
public class BackgroundModeExt extends CordovaPlugin {
    ...
    {
        getApp().runOnUiThread(() -> getApp().getWindow().addFlags(FLAG_SHOW_WHEN_LOCKED | FLAG_TURN_SCREEN_ON | FLAG_DISMISS_KEYGUARD));
    }
    ...
    {
        getApp().runOnUiThread(() -> getApp().getWindow().clearFlags( FLAG_SHOW_WHEN_LOCKED | FLAG_TURN_SCREEN_ON | FLAG_DISMISS_KEYGUARD));
    }
